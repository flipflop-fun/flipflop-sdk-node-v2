...
export type FairMintTokenV2 = {
  ...
  instructions: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "baseMint";
          address: "9R4AhtSgf1BXa356x1SpJP6jXnMBF1q9FD2RPS3s4jxP";
        },
        {
          name: "payerBaseAta";
          docs: ["Payer's USDC ATA (base token ATA)"];
          writable: true;
          pda: {
            seeds: [
              {
        ...
        },
        {
          ...
          docs: ["protocol fee account, usdc ata"];
          writable: true;
        },
        {
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "ownerLpToken";
          docs: ["Owner lp token account - config account"];
          writable: true;
        },
        {
          name: "lpMint";
          docs: ["pool lp mint, init by cp-swap"];
          writable: true;
        },
        {
          name: "tokenProgram";
    ...
    },
    {
      ...
      discriminator: [115, 170, 213, 136, 72, 135, 25, 200];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      discriminator: [60, 150, 179, 207, 159, 92, 223, 167];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      discriminator: [63, 189, 253, 38, 226, 46, 174, 8];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
    ...
    },
    {
      ...
      discriminator: [66, 190, 55, 26, 73, 69, 6, 183];
      accounts: [
        {
          name: "cpSwapProgram";
          address: "CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C";
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [156, 48, 238, 20, 112, 82, 26, 5];
    },
    {
